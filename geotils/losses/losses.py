...
from data_processing.polygon_utility import ArgMax
...
def get_criterion(name='jaccard',activation='sigmoid',w=[1.,1.,1.]):
    if(name=='dice'):
        return DiceLoss(activation=activation),1  # should remove activation=activation
        ...
        return BinaryLovaszLoss(),1  # removed activation=activation
    
    elif(name =='lovasz'):
        return LovaszLoss(),1  # removed activation=activation
