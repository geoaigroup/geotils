...
class S1Reader(Dataset):
    ...
    def __init__(self, input_dir, label_dir, label_ids=None, transform=None, min_area_to_ignore = 1000, selected_time_points=None):
        ...
        #self.npyfolder = "/mnt/c/users/ali/documents/cnrs-l internship 2021/ai4eo data/ref_fusion_competition_south_africa_train_source_sentinel_1/ref_fusion_competition_south_africa_train_source_sentinel_1_34S_19E_258N_asc_34S_19E_258N_2017/"
    ...
    def _setup(rootpath, labelgeojson, npyfolder, min_area_to_ignore=1000):
        ...
        ia = np.load(os.path.join(rootpath, "angle.npy"))
        bands = np.stack([vv[:,:,:,0],vh[:,:,:,0],ia[:,:,:,0]], axis=3)
